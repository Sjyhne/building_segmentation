...
class DataAugmentationForBEiT(object):
    ...
    def __call__(self, image):
        ...
        for_patches = map_pixels(self.patch_transform(for_patches).unsqueeze(0)).squeeze(0)
        for_visual_tokens = self.visual_token_transform(for_visual_tokens)
        masked_positions = self.masked_position_generator()

        return for_patches, for_visual_tokens, masked_positions
